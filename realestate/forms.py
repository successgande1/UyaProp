...
class PropertyForm(forms.ModelForm): 
    description = forms.CharField(label='Property Description:', max_length=100, widget=forms.TextInput(attrs={'placeholder': 'Briefly Describe your Property. E.g. Bedroom & Palour with Private Detached Bathroom'}))
    state = forms.ChoiceField(choices=Property.STATE_CHOICES, required=False)
    town = forms.CharField(label = 'Town/City:', max_length=100, widget=forms.TextInput(attrs={'placeholder': 'Enter Local Govt. of Property.'}))
    ...
    class Meta:
        model = Property
        fields = ('description', 'address', 'country', 'state', 'town', 'property_type', 'bedrooms', 'bathroom_type', 'price', 'is_available', 'image')
